...
INSERT INTO `config` (`var`, `val`, `description`, `year`) VALUES ('fairmanageremail', '', 'The email address of the ''fair manager''. This is the FROM email address for any emails generated by the system.  Any important emails etc generated by the system will be sent here', -1);
...
INSERT INTO `config` (`var`,`val`,`year`) VALUES ('DBVERSION','9','0');
