...
INSERT INTO `config` (`var`, `val`, `description`, `year`) VALUES ('project_num_format', 'CDN', 'C=Category, D=Division, N=2 digit Number', -1);
...
INSERT INTO `config` (`var`, `val` , `description` , `year` ) VALUES ( 'judge_registration_singlepassword', '', 'The single password to use for judge registration if judge_registration_type is singlepassword.  Leave blank if not using singlepassword judge registration', '-1');
INSERT INTO `config` (`var`, `val` , `description` , `year` ) VALUES ( 'participant_student_tshirt', 'no', 'Ask for students their T-Shirt size (yes/no).', '-1');
...
INSERT INTO `config` (`var`,`val`,`year`) VALUES ('DBVERSION','17','0');
